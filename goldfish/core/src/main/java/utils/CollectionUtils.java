...
public abstract class CollectionUtils {
     ...
     * @since 3.1
     */
    public static <K, V> org.springframework.util.MultiValueMap<K, V> toMultiValueMap(Map<K, List<V>> map) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> org.springframework.util.MultiValueMap<K, V> unmodifiableMultiValueMap(org.springframework.util.MultiValueMap<? extends K, ? extends V> map) {
    ...
    private static class MultiValueMapAdapter<K, V> implements org.springframework.util.MultiValueMap<K, V>, Serializable {
